...
public class BatchUpdateInventory extends HttpServlet {
    ...
    private final Product[] newProducts = {
        ...
        // Passed record
        new Product("JAVAJACKET-L", "Leather Java Jacket (Ladies)", 104.90, "Black leather Java Jacket embroidered with Java logo on back and Duke on the front left. Order specific ladies size.")
    };
