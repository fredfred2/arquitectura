...
public class OrderRecvBean implements MessageListener {

    private static final Logger logger = Logger.getLogger("com.example.OrderRecvBean");

    public OrderRecvBean() {
    }

    @Override
    public void onMessage(Message message) {
        try {
            logger.log(Level.INFO, "OrderRecvBean: " + message.getBody(String.class));
