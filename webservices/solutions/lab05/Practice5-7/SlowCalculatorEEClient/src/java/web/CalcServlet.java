...
import calc.CalculatorWS;
import calc.CalculatorWSService;
...
public class CalcServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        URL wsdlUrl = new URL("file://./META-INF/wsdls/CalculatorWSService.wsdl");
        CalculatorWSService service = new CalculatorWSService(wsdlUrl);
