...
public class DVDLibraryBean implements Serializable {
   ...
   @Inject
    ...
    private Long releaseyear=2010l;
...
public Long getCurrentYear() {
   ...
   setNewGenre("");
        ...
        FacesMessage facesMessage = new FacesMessage("Addition Not allowed, you are not an admin");
...
return "home";
 ...
 public ArrayList getGenreCount() {
        
//           // Map Genrescount = itembean.getGenreCount();
//            Collection total=itembean.getGenreCount().values();
//            Iterator g = total.iterator();
//            while (g.hasNext()) {
//                String item = (String) g.next();
//                SelectItem n = new SelectItem(item, item);
//                genreList.add(n);
